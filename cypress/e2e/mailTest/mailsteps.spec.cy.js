...
describe('testing email token extraction', () => {
  ...
  it('fill in the business name', ()=>{
    cy.get(data.biznameField).should('exist').type('automation1284')
  })
  ...
  it('fill in the phone number', () => {
    cy.get(data.phoneField).should('exist').type('+2348111111123')
  })
  it('fill in the registeration number', ()=>{
    cy.get(data.bizregField).should('exist').type('@automation1282')
  })
